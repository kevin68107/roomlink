...
$fetch = mysqli_query($conn, "SELECT * FROM pending;");
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="./approvals.php" class="active"><span class="las la-clipboard-list"></span>
                ...
                if (mysqli_num_rows($fetch) > 0) {
                    while ($dbResult = mysqli_fetch_assoc($fetch)) {
                        ...
                        echo "<tr>
                                ...
                                <td>$price</td>
                                <td>$RefID</td>
                                <td><a href='approve.php?email=$email'>Approve</a></td>
                            </tr>";
                    }
                } else {
